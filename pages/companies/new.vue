...
<template>
  <div class="flex flex-col gap-4">
    ...
    <p-card>
      <template #title>
        {{ $t('patents.new.sections.general') }}
      </template>
    ...
    <p-card>
      <template #title>
        {{ $t('location.new.sections.general') }}
      </template>
    ...
    <p-card>
      <template #title>
        {{ $t('contact.new.sections.general') }}
      </template>
    ...
    <p-card v-if="form.juridical">
      <template #title>
        {{ $t('legalRepresentation.new.sections.general') }}
      </template>
      ...
      <template #content>
        <div class="grid grid-cols-2 gap-4">
          ...
          <UiInputText
            ...
            :placeholder="$t('legalRepresentation.new.inputs.notaryAuthorization.placeholder')"
